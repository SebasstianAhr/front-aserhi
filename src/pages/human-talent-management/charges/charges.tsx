...
const Charges = (): JSX.Element => {
  ...
  const handleAddChargeWithClose = async () => {
    await handleAddCharge();
    setModalAddForm(false);
  };

  const handleEditChargeWithClose = async () => {
    await handleEditChargeSubmit();
    setModalEditItem(false);
  };
    ...
    <div className="charges">
      ...
      {showAlertRegister && (
        <Alert
          ...
          onContinue={handleAddChargeWithClose}
        />
      )}
      {showAlertEdit && (
        <Alert
          ...
          onContinue={handleEditChargeWithClose}
        />
      )}
    </div>
  );
