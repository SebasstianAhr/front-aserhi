...
import { columnsProfilePage } from '../../../core/utils/colums-table-data.util';
import { filterFieldsProfilePage } from '../../../core/utils/field-filter.util'
  ...
  return (
    <div className='profile-page'>
      ...
      <div className="profile-page__content profile-page__content--search-filter">
        <SearchFilter fieldsFilter={filterFieldsProfilePage} onFilterChange={handleFilterChange} />
      </div>
      <div className="profile-page__content profile-page__content--table">
        <TableDataContent
          data={filteredProfiles}
          columns={columnsProfilePage}
