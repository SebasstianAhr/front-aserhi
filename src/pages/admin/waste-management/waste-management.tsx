...
import { columnsWasteManagement } from '../../../core/utils/colums-table-data.util';
import { filterFieldsWasteManagement } from '../../../core/utils/field-filter.util';
  ...
  return (
    <div className='waste-management'>
      ...
      <div className='waste-management__content waste-management__content--search-filter'>
        <SearchFilter fieldsFilter={filterFieldsWasteManagement} onFilterChange={handleFilterChange} />
      </div>
      <div className='waste-management__content waste-management__content--table'>
        <TableDataContent
          data={filteredWasteData}
          columns={columnsWasteManagement}
